...
<section id="About" className="section about__section">
  ...
  <div className="about__container">
    <div className="about__content">
        <p>
          I’m a full-stack developer who thrives on transforming creative ideas into powerful digital solutions. 
        ...
        <p>
          ...
          Whether it's front-end magic or back-end logic, I’m always excited to take on new challenges and improve continuously.
        </p>
    </div>
    <div className="about__img-container">
      <img src="/about-photo.jpg" alt="About Samrudh" className="about__img" />
    </div>
  </div>
</section>
        ...
        <div className="skills__container">
          {["Complaint Management System"].map((title, i) => (
            <div key={i} className="project__card">
              ...
              <div>
                <a href="https://github.com/RuchithYK/Complaint_Management_System"><Github /></a>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="Contact" className="section">
        ...
        <div className="skills__container">
          <div className="skills__data"><Mail /> samrudh.hm@email.com</div>
          <div className="skills__data"><Phone /> +91 7894486186</div>
          <div className="skills__data"><MapPin /> India</div>
        </div>
      ...
      <footer className="footer">
        <p>© 2024 Samrudh HM</p>
        <div>
          <a href="https://github.com/Samrudh-26"><Github /></a>
          <a href="https://www.linkedin.com/in/samrudh-h-m-aaa534308/"><Linkedin /></a>
        </div>
      </footer>
    </div>
  );
